...
public class RoleOperationClaimsController : BaseController
{
    ...
    [HttpGet]
    public async Task<ActionResult<GetListRoleOperationClaimQuery>> GetList([FromQuery] PageRequest pageRequest)
    {
        GetListRoleOperationClaimQuery query = new() { PageRequest = pageRequest };
